...
import com.extjs.gxt.ui.client.widget.grid.EditSupport;
 ...
 * </dl>
 */
public class EditorTreeGrid<M extends ModelData> extends TreeGrid<M> implements EditSupport {
  ...
  public void startEditing(final int row, final int col) {
    ...
    if (cm.isCellEditable(col)) {
      ...
      GridEvent<M> e = new GridEvent<M>(this);
      e.setModel(m);
  ...
  protected void onEditComplete(CellEditor ed, Object value, Object startValue) {
    ...
    if ((value == null && startValue != null)
      ...
      GridEvent<M> ge = new GridEvent<M>(this);
      ge.setRecord(r);
