...
public interface TemplateFactory {
   ...
   * <p/>For Example
   * <p/>
   * <pre>interface com.project.client.MyTemplateFactory extends TemplateFactory {
   ...
   *<pre>
   * com/project/client/MyTemplateFactory#button.html
   * com/project/client/MyTemplateFactory#header.html
   * </pre>
   * 
   * 
   */
