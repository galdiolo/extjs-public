...
public interface GridTemplates extends Templates {
  ...
  @Cache
  public String headerCell(String id, String value, String style, String toolTip, String istyle,
      String blankImagUrl, boolean enableHdMenu);

  @Cache
  public String body(String rows);

  @Cache
  public String row(String tstyle, String alt, int cols, String cells, boolean enableRowBody,
      String body, String bodyStyle);
