 ...
 * the tag F</li>
 * <li> <b>E + F</b> all elements with the tag F that are immediately preceded
 * by an element with the tag E</li>
 ...
 * <li> <b>E:nth-child(<i>n</i>)</b> E is the <i>n</i>th child of its parent
 * (1 based as per the spec)</li>
 * <li> <b>E:nth-child(odd)</b> E is an odd child of its parent</li>
 * <li> <b>E:nth-child(even)</b> E is an even child of its parent</li>
 * <li> <b>E:only-child</b> E is the only child of its parent</li>
 * <li> <b>E:checked</b> E is an element that is has a checked attribute that
 * is true (e.g. a radio or checkbox) </li>
...
public class DomQuery {
   ...
   * @param nonMatches if true, it returns the elements that DON'T match the selector
