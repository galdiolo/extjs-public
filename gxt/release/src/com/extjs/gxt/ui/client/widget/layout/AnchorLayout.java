 ...
 * </ul>
 * 
 * <p /> By default, AnchorLayout will calculate anchor measurements based on the size
 * of the container itself. However, if <code>anchorSize</code> is specified, the layout will
 ...
 * 
 * <p /> The items added to an AnchorLayout can also supply an anchoring-specific
 ...
 * <ul>
 * <li><b>Percentage</b> : Any value between 1 and 100, expressed as a percentage. The first anchor is
 ...
 * default to auto.</li> 
 * <li><b>Offsets</b> : Any positive or negative integer value. The first anchor is the offset from
 ...
 * </ul>
 * 
 * <p /> Anchor values can also be mixed as needed. For example, '-50 75%' would
